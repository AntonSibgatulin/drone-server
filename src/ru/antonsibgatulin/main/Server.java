...
/**
 * проект реализует консольный многопользовательский чат. вход в программу
 * запуска сервера - в классе Server.
 * 
...
class Story {
	...
	/**
	 * отсылаем последовательно каждое сообщение из списка в поток вывода данному
	 * клиенту (новому подключению)
	 * 
	 * @param writer
	 */
